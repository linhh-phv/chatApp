  ...
  constructor() {
    if (!firebase.apps.length) {
      ...
      firebase.initializeApp({
        apiKey: 'AIzaSyCfBE2Pp-ZmKHwbMDzNH6IamyPi-0EI6R4',
        authDomain: 'chatapp-1521f.firebaseapp.com',
        databaseURL: 'https://chatapp-1521f-default-rtdb.firebaseio.com/',
        projectId: 'chatapp-1521f',
        storageBucket: 'chatapp-1521f.appspot.com',
        messagingSenderId: '83819543069',
      });
    }
  }
